        ...
        <div class="container-fluid">
            ...
            <div class="d-flex flex-column flex-xl-row justify-content-between align-items-xl-center mb-4 gap-3">
                <div>
                    ...
                    <p class="text-muted mb-0 small">Kelola kontrak sewa lahan, pembayaran cicilan, dan laporan data penyewa.
                    </p>
                </div>
                ...
                <div class="d-flex flex-column flex-md-row gap-2 align-items-stretch align-items-md-center">
                    <form action="{{ url('/sewa-lahan') }}" method="GET" class="d-flex flex-column flex-sm-row gap-2 mb-0">
                        ...
                        <select name="status" class="form-select" style="min-width: 130px;">
                            ...
                            <option value="mencicil" {{ request('status') == 'mencicil' ? 'selected' : '' }}>Mencicil
                            </option>
                        ...
                        <select name="waktu" class="form-select" style="min-width: 170px;">
                            ...
                            <option value="habis" {{ request('waktu') == 'habis' ? 'selected' : '' }}>❌ Sudah Habis
                            </option>
                        </select>
                        ...
                        @if (request('search') || request('status') || request('waktu'))
                            <a href="{{ url('/sewa-lahan') }}" class="btn btn-outline-secondary"
                            ...
                            <tbody>
                                @forelse($dataRentals as $index => $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- TOMBOL WHATSAPP (MENGGUNAKAN JAVASCRIPT) -->
                                            <a href="#"
                                        ...
                                        <td class="fw-bold text-primary">
                                            ...
                                            <div class="text-muted fw-normal" style="font-size: 11px;">Durasi:
                                                {{ $row->contract_duration_months }} Bulan</div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @elseif($row->status_tampilan == 'mencicil')
                                                <span
                                                    class="badge bg-warning text-dark rounded-pill px-3 py-2">Mencicil</span>
                                            @else
                                        ...
                                        <td class="text-center pe-3">
                                            ...
                                            <div class="dropdown">
                                                <button
                                                    class="btn btn-outline-secondary btn-sm dropdown-toggle p-2 shadow-sm"
                    ...
                    <div class="modal-content border-0 shadow rounded-3">
                        ...
                        <div class="modal-body p-3 p-md-4">
                            ...
                            <form action="{{ url('/sewa-lahan/simpan-cicilan/' . $row->id) }}" method="POST"
                                ...
                                @csrf
                                <h6 class="fw-bold mb-3 small"><i class="bi bi-plus-circle me-1"></i>Input Setoran Baru
                                </h6>
                                <div class="row g-2">
                            ...
                            <div class="table-responsive">
                                <table
                                    class="table table-bordered table-sm align-middle text-nowrap mb-0 text-center small">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-muted py-3">Belum ada cicilan yang masuk.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow rounded-3">
                        <div class="modal-header bg-warning">
                            <h5 class="modal-title fs-6 text-dark"><i class="bi bi-pencil-square me-2"></i>Edit Data
                                Kontrak
                            </h5>
                        ...
                        <form action="{{ url('/sewa-lahan/update/' . $row->id) }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="payment_status" class="form-select bg-light" disabled>
                                            ...
                                            <option value="mencicil"
                                                {{ $row->payment_status == 'mencicil' ? 'selected' : '' }}>Mencicil
                                            </option>
                                            <option value="lunas"
                                                {{ $row->payment_status == 'lunas' ? 'selected' : '' }}>
                                                Lunas</option>
                                        </select>
                            ...
                            <div class="modal-footer bg-light border-0">
                                ...
                                <button type="submit" class="btn btn-primary w-100 w-md-auto px-4">Update
                                    Kontrak</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="modal-body p-3 p-md-4 text-start">
                            ...
                            <div class="row g-3 mb-4 pb-3 border-bottom">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="date" class="form-control bg-light text-danger fw-bold"
                            ...
                            <!-- BAGIAN PEMBAYARAN AWAL (SMART FORM) -->
                            <div class="row g-3">
                                <div class="col-12">
                            ...
                            <!-- Elemen Dinamis (Muncul Jika Mencicil atau Lunas) -->
                            <div class="row g-3 mt-1 bg-primary bg-opacity-10 p-3 rounded-3 mt-3"
                                id="dynamic_payment_section" style="display: none;">
                                ...
                                <div class="col-12" id="lunas_text_info" style="display: none;">
                                    <small class="text-success fw-bold"><i class="bi bi-info-circle-fill me-1"></i>Sistem
                                        akan
